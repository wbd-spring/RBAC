										...
										<td colspan="6" align="center">
											<ul class="pagination">
												...
												<c:if test="${pageNum > 1 }">
													...
													<li><a href="#" onclick="chanagePage(${pageNum - 1 })">上一页</a></li>
												...
												<c:forEach begin="1" end="${totalPage}" varStatus="status">
													...
													<c:if test="${pageNum != status.count}">
														<li><a href="#" onclick="chanagePage(${status.count })">${status.count }</a></li>
													</c:if>
												...
												<c:if test="${pageNum < totalPage }">
													...
													<li><a href="#"  onclick="chanagePage(${pageNum + 1 })">下一页</a></li>
