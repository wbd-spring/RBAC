						...
						<form id="userForm" role="form">
							<div class="form-group">
								<label for="exampleInputPassword1">登陆账号</label> <input
									type="text" class="form-control" id="account" value="${user.account }"
									placeholder="请输入登陆账号">
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<label for="exampleInputEmail1">邮箱地址</label> <input type="email"
									class="form-control" id="email" placeholder="请输入邮箱地址"  value="${user.email }">
							...
							<button id="restBtn" type="button" class="btn btn-danger">
		...
		$(function() {
			...
			$("#updateBtn").click(function(){
				...
				if(username==''){
					 ...
					 layer.msg("名称不能为空", {time:2000, icon:5, shift:6}, function(){
				...
				if(email==''){
					 ...
					 layer.msg("email能为空", {time:2000, icon:5, shift:6}, function(){
