				...
				<ul style="padding-left:0px;" class="list-group">
					...
					<li class="list-group-item">
						...
						<ul style="margin-top:10px;">
							...
							<li style="height:30px;">
								<a href="${APP_PATH}/role/inde" style="color:red;"><i class="glyphicon glyphicon-king"></i> 角色维护</a> 
							</li>
							<li style="height:30px;">
            	...
            	$.ajax({
            		...
            		success:function(result){
            			...
            			if(result.success){
            				...
            				//1 .获取 到数据， 包含Page<Role> ,角色列表，总页数，当前页，
            				...
            				//4.已经获取到总页数， 进行循环迭代，每一页
            				
            				for(var i=1;i<=rolePage.totalPage;i++){
            					
            					
            					if(pageNum==i){ //如果是当前页，这高亮显示， 不能点击
            						
            						pageContent += '<li class="active"><a href="#">'+i+' <span class="sr-only">'+i+'</span></a></li>';
            					}else{
            				...
            				//5.对下一页进行判断,如果当前页小于总页数，显示下一页
            				if(pageNum<rolePage.totalPage){
            				...
            				$("#roleData").html(tableContent); //#为id选择器
