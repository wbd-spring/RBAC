				...
				<ul style="padding-left:0px;" class="list-group">
					...
					<li class="list-group-item">
						...
						<ul style="margin-top:10px;">
							...
							<li style="height:30px;">
								<a href="role.html"><i class="glyphicon glyphicon-certificate"></i> 许可维护</a> 
							</li>
							<li style="height:30px;">
				...
				<form role="form">
				  ...
				  <div class="form-group">
				   ...
				   <div class="form-group">
					...
					<input type="text" class="form-control"  value="${permission.url }" id="url" placeholder="请输入许可名称">
				  </div>
            ...
            $(function () {
			    ...
			    $("#updateBtn").click(function(){
			    	...
			    	$.ajax({
			    		...
			    		type:"post",
			    		data:{"name":permissionName,"id":"${param.id}","url":$("#url").val()},
